...
$_['datepicker']                    = 'ru';
			...
			if (file_exists(DIR_MODIFICATION . "catalog/language/ru-ru/octemplates/oct_feelmart.php")) {
				include(DIR_MODIFICATION . "catalog/language/ru-ru/octemplates/oct_feelmart.php");
			} else {
				include(DIR_LANGUAGE."ru-ru/octemplates/oct_feelmart.php");
			}