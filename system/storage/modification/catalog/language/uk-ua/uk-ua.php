...
$_['error_curl'] = 'CURL: Помилка коду(%s): %s';
			if (file_exists(DIR_MODIFICATION . "catalog/language/uk-ua/octemplates/oct_feelmart.php")) {
				include(DIR_MODIFICATION . "catalog/language/uk-ua/octemplates/oct_feelmart.php");
			} else {
				include(DIR_LANGUAGE."uk-ua/octemplates/oct_feelmart.php");
			}