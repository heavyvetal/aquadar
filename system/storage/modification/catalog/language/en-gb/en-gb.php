...
//$_['datepicker']            = 'zh-hk';
//$_['datepicker']            = 'zh-tw';
			if (file_exists(DIR_MODIFICATION . "catalog/language/en-gb/octemplates/oct_feelmart.php")) {
				include(DIR_MODIFICATION . "catalog/language/en-gb/octemplates/oct_feelmart.php");
			} else {
				include(DIR_LANGUAGE."en-gb/octemplates/oct_feelmart.php");
			}