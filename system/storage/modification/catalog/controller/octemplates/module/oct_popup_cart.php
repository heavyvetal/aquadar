...
class ControllerOCTemplatesModuleOctPopupCart extends Controller {
    public function index() {
		if ($this->config->get('theme_oct_feelmart_popup_cart_status') && isset($this->request->server['HTTP_X_REQUESTED_WITH']) && !empty($this->request->server['HTTP_X_REQUESTED_WITH']) && strtolower($this->request->server['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
			$data = [];
