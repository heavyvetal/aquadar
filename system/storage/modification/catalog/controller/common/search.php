...
class ControllerCommonSearch extends Controller {
	public function index() {
		$this->load->language('common/search');
	        ...
	        // start: OCT liveSearch
	        if ($this->config->get('theme_oct_feelmart_live_search_status')) {
				$oct_live_search_data = $this->config->get('theme_oct_feelmart_live_search_data');
				$data['oct_live_search_status'] = $this->config->get('theme_oct_feelmart_live_search_status');
