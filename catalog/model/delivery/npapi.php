...
class ModelDeliveryNPApi extends Model
{
     ...
     *
     * @return ModelDeliveryNovaPoshtaApi
     */
    public function __construct($registry, $key = '', $language = 'ru', $throwErrors = true, $connectionType = 'curl')
    {
